import { IS_LOADING,GET_DOGS,GET_DOG_DETAILS,SEARCH_DOGS,GET_TEMPERAMENTS,ADD_DOG, FILTER_BY_TEMPERAMENTS, FILTER_BY_RACES, FILTER_BY_ORIGIN,ORDER_BY_ALPHABET,ORDER_BY_WEIGHT, DARK_MODE } from "../actions"
const initialState={
dogs:[],
allDogs:[],
temperaments:[],
